...
import { getAllProducts, getProductDetail, clean, getAllCategories, createProduct, editProduct } from '../../../redux/actions'
...
const EditProduct = () => {
  ...
  return (
    ...
    <form>
     ...
     <Select className='rounded-md placeholder:text-center text-center h-8 text-xl w-full mb-3' onChange={handleSelect} options={options} defaultValue={{value:product.category[0], label:product.category[0]}}/>
      {category==='Otro' ? <div className="flex flex-row gap-4 items-center">
      <input className='border rounded-md placeholder:text-center text-center h-8 text-xl w-full' type='text' name='category' value={formOne.category}  onChange={handleFormOne} placeholder='Nueva categoría'/> 
    ...
    {errorOne.price ? <div>✅</div> : <div>❌</div>}
      ...
      {/* DESCRIPCION */}
      <div className="flex flex-row gap-4 ml-5 items-center">
      <textarea className='border rounded-md placeholder:text-center resize-y h-48 text-xl w-full' name="description" value={formOne.description} onChange={handleFormOne} placeholder='Descripcion' />
      ...
      <Select className='rounded-md placeholder:text-center text-center h-8 text-xl w-full mb-3' placeholder='Compatibilidad de marcas' name='brand' onChange={selectBrand} options={brands} defaultValue={{value:product.compatibilityBrands,label:product.compatibilityBrands}}/>
      ...
      {marca !== null && <Select defaultValue={{value:product.socket,label:product.socket}} className='rounded-md placeholder:text-center text-center h-8 text-xl w-full mb-3' placeholder='Socket' onChange={selectSocket} options={marca==='AMD' ? AMD : INTEL}/>}

      <Select defaultValue={{value:product.factorMother,label:product.factorMother}} className='rounded-md placeholder:text-center text-center h-8 text-xl w-full mb-3' placeholder='Factor Mother' onChange={selectFactor} options={factor}/>
      ...
      <Select defaultValue={{value:product.inOffer,label:product.inOffer}} className='rounded-md placeholder:text-center text-center h-8 text-xl w-full mb-3' placeholder='Oferta' onChange={selectOffer} options={customOffer}/>
