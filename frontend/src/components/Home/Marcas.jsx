...
export default function Marcas() {      
  return (
    <div className='h-5/6 w-full flex flex-col items-center justify-center lg:mt-28 sm:mt-20 mb-11 '>
    ...
    <div></div>
    <div className='lg:w-[55%] sm:w-[90%] lg:h-1/4 sm:h-24  flex justify-center mt-4'>
