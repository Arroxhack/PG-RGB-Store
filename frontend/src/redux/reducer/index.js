...
import { ADD_CART, GET_ALL_PRODUCTS, GET_PRODUCT_DETAIL, RESET_CART, SEARCH_PRODUCTS,FILTER_BY_PRICE, GET_CATEGORIES,SET_FILTER, FILTER_CATEGORIES, CREATE_PRODUCT, GET_BRANDS, FILTER_BRANDS} from '../types/index';
const initialState = {
  allProducts: [],
  products: [],
  detail: [],
